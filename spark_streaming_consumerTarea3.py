...
schema = StructType([
        ...
        StructField("carril_escolar", FloatType()),
        StructField("servicio_publico", FloatType()),
        StructField("mixto", FloatType()),
...
windowed_stats = parsed_df \
        ...
        .agg({"carril_escolar": "avg", "servicio_publico": "avg", "mixto" : "avg"})
